...
public class TestDaoText1 implements TestDAO {
	private File testFile = null;

	public TestDaoText1() {
		testFile = new File(TestConstants.FILENAME_TEXT1);
	}
	...
	public Test getTest() {
		...
		try {
			...
			//	double maxMarks = Double.parseDouble(columns[2]);
				t = new Test(testname,email,review);
	...
	public ArrayList<Test> getTests() {
		...
		//	int sli1 = int.parseInt(columns[1]);
			//	double maxMarks = Double.parseDouble(columns[2]);
				Test t = new Test(name,email,review);
				tests2.add(t);
				line = in.readLine();
			}
